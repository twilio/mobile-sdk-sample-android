package com.twilio.authenticatorsample.approvalrequests.detail;
...
import com.twilio.authenticatorsample.BuildConfig;
import com.twilio.authenticatorsample.R;
import com.twilio.authenticatorsample.approvalrequests.adapters.ApprovalRequestInfoAdapter;
...
@Config(constants = BuildConfig.class, application = TestSampleApp.class)
public class ApprovalRequestDetailActivityTest {
    ...
    private TestSampleApp context;
    private MockTwilioAuthenticator mockTwilioAuthenticator;

    @Before
    public void setUp() throws Exception {
        context = (TestSampleApp) RuntimeEnvironment.application;
